...
function App() {
  ...
  return (
    <div className="bg-[#f0fdf4] text-slate-800 font-sans w-full relative min-h-screen">
            ...
            <section className="relative min-h-[680px] flex items-center overflow-hidden">
              <div className="absolute inset-0 z-0 opacity-10 p-8">
                <div className="w-full h-full rounded-3xl overflow-hidden"
                  style={{ boxShadow: '8px 8px 20px rgba(6,95,70,0.1), -6px -6px 16px rgba(255,255,255,0.9)' }}>
                  <img
              ...
              <div className="container mx-auto px-8 relative z-20">
                <div className="max-w-3xl p-10 rounded-[3rem] bg-white/40 backdrop-blur-md border border-white/60 shadow-2xl">
                  ...
                  <p className="text-lg text-slate-600 max-w-xl mb-10 border-l-4 border-emerald-300 pl-5 py-2 font-semibold leading-relaxed">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button onClick={() => setView('tracker')}
                      ...
                      style={{ background: 'linear-gradient(145deg,#059669,#047857)', boxShadow: '0 10px 25px rgba(5,150,105,0.3)' }}>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/70 backdrop-blur-2xl flex justify-around items-center px-4 py-3 md:hidden border-t border-emerald-50 shadow-2xl">
        {[
